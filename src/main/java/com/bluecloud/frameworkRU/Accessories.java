...
public class Accessories extends HtmlReporters {
	...
	/***
	 * This method is supposed to be used in the @BeforeSuite in-order trigger the
	 * Suite Start Time which inturn used to calculate the Total Suite execution
	 * time to show in Reports.
	 */
	...
	/***
	 * This method is supposed to be used in the @AfterMethod to calculate the total
	 * suite execution time to show in Reports by taking the suite start time from
	 * the calculateSuiteStartTime method.
	 */
	public static void calculateSuiteExecutionTime() {

		HtmlReporters.iSuiteEndTime = System.currentTimeMillis(); // Newly added
		HtmlReporters.iSuiteExecutionTime = (HtmlReporters.iSuiteEndTime - HtmlReporters.iSuiteStartTime) / 1000.000;// Newly
																														// added
	}
	...
	public static void calculateStepExecutionTime() {
		...
		HtmlReporters.iStepExecutionTime = (HtmlReporters.iStepEndTime - HtmlReporters.iStepStartTime) / 1000;// Newly
																												// added
